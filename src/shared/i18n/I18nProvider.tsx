...
const translations = {
  en: {
    ...
    'import.label': 'Upload', 'import.title': 'Import a track', 'import.midi': 'MIDI', 'import.audio': 'Audio', 'import.midiHint': 'Open instantly in Studio', 'import.audioHint': 'Process and add to your library', 'import.processing': 'Processing audio', 'import.processingHint': 'Processing can take up to 20 minutes. You can close this window.', 'import.close': 'Close', 'import.error': 'Audio processing failed. Please try again.', 'import.timeout': 'Audio processing exceeded the 20-minute limit.',
  ...
  zh: {
    ...
    'import.label': '上传', 'import.title': '导入曲目', 'import.midi': 'MIDI', 'import.audio': '音频', 'import.midiHint': '立即进入 Studio 预览', 'import.audioHint': '处理后添加到曲库', 'import.processing': '正在处理音频', 'import.processingHint': '处理最长可能需要 20 分钟，您可以关闭此窗口。', 'import.close': '关闭', 'import.error': '音频处理失败，请稍后重试。', 'import.timeout': '音频处理超过 20 分钟限制，已停止等待。',
